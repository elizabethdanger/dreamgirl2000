...
const USER = "matsuoka-287-c";
const PW = "88kakyoin88";

/** Boot screen */
export async function boot() {
	clear();

	await type("Welcome to DREAMGIRL2000(TM) admin console", {
		initialWait: 3000
	});

	await type(["> SET CONSOLE/BOOT", "Loading........................"], {
		lineWait: 1000
	});
	await type(
		[
	...
	await type(["> SET USER/LOGON", "USER AUTHENTICATION CHECK"], {
		lineWait: 1000,
		finalWait: 3000
	});
...
export async function main() {
	type(["Welcome to the admin console. Please input command below."]);
